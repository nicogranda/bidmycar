// src/components/auth/LoginGoogle.js
import React from 'react';
import { GoogleLogin } from '@react-oauth/google';
import { useNavigate } from 'react-router-dom';
import { getConfig } from '../config'; // Importar la configuración

function LoginGoogle() {
  const navigate = useNavigate();
  const { apiUrl } = getConfig(); // Obtener la URL de la API según el entorno
